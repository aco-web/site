...
let card_content = [
                    ...
                    "<h1>ACO Security & Ad Blocker</h1>",
                    "<p class='price'>App</p>",
                    "<p>ACO Online Security and Ad blocker! The best free secure service online!</p>",
                    "<button onclick='window.location.href=`https://comingsoon.acodevelopment.repl.co/`;'>Get it now!</button>"],
                    /* PRODUCT 1*/
                    /* PRODUCT 2*/
                 ...
                 "<h1>ACO Store</h1>",
                 "<p class='price'>Merchandise Store</p>",
                 ...
                 "<h1>ACO Open</h1>",
                 "<p class='price'>Tools & Resources</p>",
